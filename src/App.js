    ...
    <>
      <Router>
        <Routes>
          ...
          <Route
            path="/ServiceCategoryProvidedReason"
            element={<ServiceCategoryProvidedReason />}
          />
          <Route
            path="/ServiceCategoryProvidedAnotherReason"
            element={<ServiceCategoryProvidedAnotherReason />}
          />
        </Routes>
      </Router>
    </>
